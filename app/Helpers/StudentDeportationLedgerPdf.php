...
class StudentDeportationLedgerPdf extends TCPDF
{
    ...
    private const DEFAULT_HEADER_TITLE_AR = 'دفتر حسابات الترحيل';
    private const DEFAULT_HEADER_TITLE_EN = 'Student Deportation Ledger Report';
